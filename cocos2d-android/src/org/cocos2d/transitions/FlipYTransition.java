...
public class FlipYTransition extends OrientedTransitionScene {
    ...
    public static FlipYTransition transition(float t, CCScene s, int orientation) {
        return new FlipYTransition(t, s, orientation);
    }

    public FlipYTransition(float t, CCScene s, int orientation) {
