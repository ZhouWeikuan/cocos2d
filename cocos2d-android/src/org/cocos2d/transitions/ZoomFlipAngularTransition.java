...
public class ZoomFlipAngularTransition extends OrientedTransitionScene {
    ...
    public static ZoomFlipAngularTransition transition(float t, CCScene s, int orientation) {
        return new ZoomFlipAngularTransition(t, s, orientation);
    }

    public ZoomFlipAngularTransition(float t, CCScene s, int orientation) {
