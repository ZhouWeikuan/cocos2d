...
public class FlipAngularTransition extends OrientedTransitionScene {
    ...
    public static FlipAngularTransition transition(float t, CCScene s, int orientation) {
        return new FlipAngularTransition(t, s, orientation);
    }

    public FlipAngularTransition(float t, CCScene s, int orientation) {
