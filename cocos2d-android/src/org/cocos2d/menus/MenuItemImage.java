...
public class MenuItemImage extends MenuItemSprite {
    ...
    public static MenuItemImage item(String value, String value2, CCNode t, String s) {
    ...
    public static MenuItemImage item(String normalI, String selectedI, String disabledI, CCNode t, String sel) {
        return new MenuItemImage(Sprite.sprite(normalI), Sprite.sprite(selectedI), (disabledI == null) ? null : Sprite.sprite(disabledI), t, sel);
    }

    protected MenuItemImage(Sprite normal, Sprite selected, Sprite disabled, CCNode t, String sel) {
